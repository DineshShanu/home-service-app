...
function Hero() {
    return (
        <div className='flex items-center gap-1 flex-col justify-center pt-14 pb-7'>
            <h2 className='font-bold text-[46px] text-center'>Find Home
                <span className='text-primary'> Service/Repair</span><br />
                Near You</h2>
            ...
            <div className='mt-4 flex gap-3 items-center'>
                ...
                <Button className="rounded-full md:w-[41px]">
