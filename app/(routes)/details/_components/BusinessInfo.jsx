  ...
  return business?.name && (
    <div className='md:flex gap-4 items-center'>
      ...
      <div className='flex justify-between items-center w-full'>
        <div className='flex flex-col mt-4 md:mt-0 items-baseline gap-2'>
        ...
        <div className='flex flex-col gap-3 items-end'>
          <Button><Share /></Button>
          <h2 className='flex gap-1 text-lg text-primary'><User />{business.contactPerson}</h2>
          <h2 className='flex gap-1 text-lg text-gray-500'><Clock />Available 8 AM to 10 PM </h2>
        </div>
      </div>
    </div>
  )
